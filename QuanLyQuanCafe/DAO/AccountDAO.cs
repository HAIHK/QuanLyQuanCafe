...
namespace QuanLyQuanCafe.DAO
{
    public class AccountDAO
    {
        ...
        {
           int result = DataProvider.Instance.ExecuteNonQuery("exec USP_UpdateAccount @userName , @displayName , @password , @newPassword ", new object[] {userName, displayName, "1962026656160185351301320480154111117132155", newPass});
